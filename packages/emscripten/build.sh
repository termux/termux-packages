...
_LLVM_COMMIT=800f0f1546b2352ba42a4777149afb13cb874fcd
_LLVM_TGZ_SHA256=b4112a4c0fa68c2416b8181e8d769493e964a29228c866771e3ec28f566434d6

# https://github.com/emscripten-core/emscripten/issues/12252
# upstream says better bundle the right binaryen revision for now
_BINARYEN_COMMIT=a803a0830586aaa3e9c989403881298b430f312c
_BINARYEN_TGZ_SHA256=ffa4634bda2523d8ddc582b4f2b1a17ea3281fa651e75bf6054cf2554b2704ef
...
termux_step_make_install() {
	...
	EOF
	install -Dm644 "${TERMUX_PKG_TMPDIR}/emscripten.sh" "${TERMUX_PKG_MASSAGEDIR}/${TERMUX_PREFIX}/etc/profile.d/emscripten.sh"
	...
	# wasm32 triplets
	rm -fr "${TERMUX_PKG_MASSAGEDIR}/${TERMUX_PREFIX}"/opt/emscripten-llvm/bin/wasm32-{clang,clang++,wasi-clang,wasi-clang++}
	rm -fr "${TERMUX_PKG_MASSAGEDIR}/${TERMUX_PREFIX}/opt/emscripten-llvm/bin/wasm-ld"
	ln -fs "clang"   "${TERMUX_PKG_MASSAGEDIR}/${TERMUX_PREFIX}/opt/emscripten-llvm/bin/wasm32-clang"
	ln -fs "clang++" "${TERMUX_PKG_MASSAGEDIR}/${TERMUX_PREFIX}/opt/emscripten-llvm/bin/wasm32-clang++"
	ln -fs "clang"   "${TERMUX_PKG_MASSAGEDIR}/${TERMUX_PREFIX}/opt/emscripten-llvm/bin/wasm32-wasi-clang"
	ln -fs "clang++" "${TERMUX_PKG_MASSAGEDIR}/${TERMUX_PREFIX}/opt/emscripten-llvm/bin/wasm32-wasi-clang++"
	ln -fs "lld"     "${TERMUX_PKG_MASSAGEDIR}/${TERMUX_PREFIX}/opt/emscripten-llvm/bin/wasm-ld"
}
