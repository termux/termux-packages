...
TERMUX_PKG_DESCRIPTION="DESS-STATION Security Suite for metadata integrity and binary validation"
TERMUX_PKG_LICENSE="MIT"
TERMUX_PKG_MAINTAINER="Dess-Services <dessservicesofc@gmail.com>"
TERMUX_PKG_VERSION=3.2
TERMUX_PKG_SRCURL=https://github.com/Dess-Services/dess-repo/archive/refs/tags/v${TERMUX_PKG_VERSION}.tar.gz
