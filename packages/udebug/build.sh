TERMUX_PKG_HOMEPAGE=https://github.com/JeckAsChristopher/udebug
...
TERMUX_PKG_SRCURL=https://github.com/JeckAsChristopher/udebug/archive/refs/tags/v${TERMUX_PKG_VERSION}.tar.gz
