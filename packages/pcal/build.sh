...
termux_step_make_install() {
	install -Dm700 -t $TERMUX_PKG_MASSAGEDIR/$TERMUX_PREFIX/bin ./exec/pcal
	install -Dm700 -T ./doc/pcal.man $TERMUX_PKG_MASSAGEDIR/$TERMUX_PREFIX/share/man/man1/pcal.1
}
