...
TERMUX_PKG_DEPENDS="boost, dbus, libandroid-wordexp, libc++, libcurl, libflac, liblog4c, libmad, libmediainfo, libmp3lame, liboggz, libopus, libsndfile, libuuid, libvpx, libmpg123, opusfile, pulseaudio, python, sqlite, taglib"
