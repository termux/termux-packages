...
TERMUX_PKG_DEPENDS="libandroid-support, libandroid-glob, libgetpass, json-c, libsqlite, libcurl, libxml2, stfl, ncurses, openssl"
...
termux_step_pre_configure() {
	export LDFLAGS+=" -L${TERMUX_PREFIX}/lib -lgetpass"
}
