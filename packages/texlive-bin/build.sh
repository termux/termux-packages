...
TERMUX_PKG_DEPENDS="freetype, harfbuzz, harfbuzz-icu, libandroid-complex-math, libc++, libcairo, libgd, libgmp, libgraphite, libiconv, libicu, libmpfr, libpaper, libpixman, libpng, lua52, teckit, zlib"
# pcre2, glib, fontconfig are dependencies of libcairo. pkg-config gives an error if they are missing
# libuuid, libxml2 are needed by fontconfig
TERMUX_PKG_BUILD_DEPENDS="icu-devtools, glib, fontconfig, libuuid, libxml2, pcre2"
...
RANLIB=ranlib
--bindir=$TERMUX_PREFIX/bin/texlive
--build=$TERMUX_BUILD_TUPLE
--datarootdir=$TERMUX_PREFIX/share/texlive/${TERMUX_PKG_VERSION:2:6}
--disable-dialog
--disable-gregorio
--disable-luajittex
--disable-makejvf
