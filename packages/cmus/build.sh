...
TERMUX_PKG_DEPENDS="libandroid-support, ncurses, pulseaudio"
TERMUX_PKG_BUILD_DEPENDS="libflac, libmad, libvorbis, opusfile, ffmpeg"
TERMUX_PKG_RECOMMENDS="ffmpeg"
TERMUX_PKG_SUGGESTS="libflac, libmad, libvorbis, opusfile"
