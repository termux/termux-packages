...
termux_step_install_license() {
	mkdir -p $TERMUX_PKG_MASSAGEDIR/$TERMUX_PREFIX/share/doc/netcat-openbsd
	head -n28 netcat.c | tail -n+2 > $TERMUX_PKG_MASSAGEDIR/$TERMUX_PREFIX/share/doc/netcat-openbsd/LICENSE
}
