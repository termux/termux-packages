...
TERMUX_PKG_SHA256=3e2ed89d81d210322d70b35460166d4ea285e5bb017576972a1d76a09631985c
...
termux_step_post_massage() {
	...
	if [ ! -e "lib/libxml2.so.${_SOVERSION}" ]; then
		echo "ERROR - Expected: lib/libxml2.so.${_SOVERSION}"
		echo "ERROR - Found   : $(find lib/libxml2* -regex '.*so\.[0-9]+')"
