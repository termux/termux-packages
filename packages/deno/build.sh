...
TERMUX_PKG_VERSION="1:2.8.2"
TERMUX_PKG_REVISION=1
TERMUX_PKG_SRCURL="https://github.com/denoland/deno/releases/download/v${TERMUX_PKG_VERSION:2}/deno_src.tar.gz"
TERMUX_PKG_SHA256=7cddb4439dcdc40c95e49ed9a17440dcf967db0052dfa330693358afd625c218
TERMUX_PKG_DEPENDS="libandroid-stub, libffi, sqlite, zlib"
