...
TERMUX_PKG_DESCRIPTION="Unified development suite for APK building, Web, and Native coding. This package is dedicated to all beginner programmers and those who have recently discovered Termux, providing essential tools and exclusive diagnostic commands to streamline the learning curve."
...
TERMUX_PKG_DEPENDS="python, openjdk-17, clang, binutils, coreutils, nano, php, git, aapt2, dx, ecj, zlib, libandroid-support, p7zip, zstd, lz4, xz-utils, apksigner, make, cmake, gdb"
