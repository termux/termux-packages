...
install -m 755 "$TERMUX_PKG_SRCDIR/bin/dev-help" "$TERMUX_PREFIX/bin/"
install -m 755 "$TERMUX_PKG_SRCDIR/bin/dev-dx-help" "$TERMUX_PREFIX/bin/"
install -m 755 "$TERMUX_PKG_SRCDIR/bin/dev-aapt2-help" "$TERMUX_PREFIX/bin/"
install -m 755 "$TERMUX_PKG_SRCDIR/bin/dev-sign-help" "$TERMUX_PREFIX/bin/"
install -m 755 "$TERMUX_PKG_SRCDIR/bin/d-compact" "$TERMUX_PREFIX/bin/"
install -m 755 "$TERMUX_PKG_SRCDIR/bin/d-archive-test" "$TERMUX_PREFIX/bin/"
}
