...
termux_step_get_source() {
	...
	termux_download "https://github.com/meganz/sdk/archive/${_MEGA_SDK_VERSION}.tar.gz" \
...
termux_step_pre_configure() {
	tar -xvf "${TERMUX_PKG_CACHEDIR}/mega-${TERMUX_PKG_VERSION}_Linux.tar.gz"
	cd "MEGAcmd-${TERMUX_PKG_VERSION}_Linux/"

	mkdir -p sdk
	tar -xvf "${TERMUX_PKG_CACHEDIR}/mega-sdk-${_MEGA_SDK_VERSION}.tar.gz"
