...
TERMUX_PKG_SHA256=c5e446496f34c42d353ad006e93572ebfcca4dc48535fb428270fe0affce38b9
...
TERMUX_PKG_DEPENDS="libandroid-glob, libandroid-support, libbz2, libc++, libcurl, libffi, libgmp, libiconv, libicu, libresolv-wrapper, libsqlite, libxml2, libxslt, libzip, oniguruma, openssl, pcre2, readline, tidy, zlib, capstone"
