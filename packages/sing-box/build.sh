...
TERMUX_PKG_SHA256=a6462c1c41acfea0ac1c815985e6573dc92895541f75f678c805203879421927
...
termux_step_make() {
	...
	local tags="with_gvisor,with_quic,with_grpc,with_wireguard,with_utls,with_clash_api"
	local ldflags="\
	-w -s \
