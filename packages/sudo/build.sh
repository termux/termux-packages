...
# FIXME: Fix urls
TERMUX_PKG_SRCURL=git+https://github.com/agnostic-apollo/sudo
TERMUX_PKG_GIT_BRANCH="1.0.0-prerelease"
...
termux_step_install_license() {
	...
	mv "$TERMUX_PKG_SRCDIR/licenses/agnostic-apollo__sudo__MIT.md" "$TERMUX_PREFIX/share/doc/$TERMUX_PKG_NAME/licenses/"
}
