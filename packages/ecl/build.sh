...
TERMUX_PKG_EXTRA_HOSTBUILD_CONFIGURE_ARGS=" --enable-boehm=system  --without-backtrace --enable-libatomic=system  --enable-gmp=system --with-unicode-names=32"
# for 32 bit archs
# sudo dpkg --add-architecture i386
# sudo apt update
# apt-get install libc6:i386 libncurses5:i386 libstdc++6:i386 libgmp-dev:i386
...
if [ "$TERMUX_ARCH_BITS" = "32" ]; then
	...
	CXX="g++ -m32"	CC=" gcc -m32 $LDFLAGS"  CFLAGS=" -m32" CXXFLAGS=" -m32" ./configure $TERMUX_PKG_EXTRA_HOSTBUILD_CONFIGURE_ARGS --prefix=$TERMUX_COMMON_CACHEDIR32
