...
TERMUX_PKG_SHA256=b27e0b4c47573bc0cc2cc7844a6c9372fed053a49aca23f5aa54edd2958ae558
# apt-key requires utilities from coreutils, findutils, gpgv, grep, sed.
TERMUX_PKG_DEPENDS="coreutils, dpkg, findutils, gpgv, grep, libandroid-glob, libbz2, libc++, libiconv, liblz4, liblzma, libseccomp, openssl, sed, termux-keyring, termux-licenses, xxhash, zlib, zstd"
