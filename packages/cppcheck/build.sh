...
TERMUX_PKG_SHA256=ef7d77c16e6903834cc016986a60157918a90958e981863746a7f3147bfb94c6
...
TERMUX_PKG_EXTRA_CONFIGURE_ARGS+=" -DDISABLE_DMAKE=ON -DCMAKE_DISABLE_PRECOMPILE_HEADERS=ON"
