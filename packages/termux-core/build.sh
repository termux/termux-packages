...
# FIXME: Fix urls
TERMUX_PKG_SRCURL=git+https://github.com/termux/termux-core-package
TERMUX_PKG_GIT_BRANCH="0.1.0-prerelease"
...
TERMUX_PACKAGES__REPO_NAME=${TERMUX_PACKAGES__REPO_NAME} TERMUX_PACKAGES__REPO_URL=${TERMUX_PACKAGES__REPO_URL} \
TERMUX_PACKAGES__REPO_DIR=${TERMUX_SCRIPTDIR} \
