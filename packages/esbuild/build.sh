...
TERMUX_PKG_VERSION="0.18.13"
TERMUX_PKG_SRCURL=https://github.com/evanw/esbuild/archive/refs/tags/v${TERMUX_PKG_VERSION}.tar.gz
TERMUX_PKG_SHA256=3144c785c664086050e1aa48ccef837b113c3565bc524a425043d812dc450345
...
termux_step_make_install() {
	install -Dm700 -t $TERMUX_PKG_MASSAGEDIR/$TERMUX_PREFIX/bin esbuild
}
