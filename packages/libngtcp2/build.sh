...
TERMUX_PKG_SRCURL=https://github.com/ngtcp2/ngtcp2/archive/refs/tags/v${TERMUX_PKG_VERSION}.tar.gz
TERMUX_PKG_SHA256=3bd1217c259d0a41807fe442368b9843ff2315910b7051211d0f24bac53acd39
TERMUX_PKG_BUILD_DEPENDS="brotli"
TERMUX_PKG_DEPENDS="gnutls, openssl"
