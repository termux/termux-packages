...
TERMUX_PKG_DESCRIPTION="Cross-Platform, beautiful and powerful stream downloader for DASH/HLS."
TERMUX_PKG_LICENSE="MIT"
TERMUX_PKG_MAINTAINER="@termux"
TERMUX_PKG_VERSION="0.3.0-beta"
TERMUX_PKG_SRCURL="https://github.com/nilaoda/N_m3u8DL-RE/archive/refs/tags/v${TERMUX_PKG_VERSION}.tar.gz"
...
TERMUX_PKG_DEPENDS="openssl, openssl-static"
