...
TERMUX_PKG_SHA256=6199c4cacc0b411fde7ec6c66d12829459284c6cdfb4bacce7b535190d5cd94c
TERMUX_PKG_BUILD_DEPENDS="freetype, libandroid-wordexp-static, libelf, libxcb, libxrandr, mesa-dev, ocl-icd, opencl-headers, pulseaudio, vulkan-headers, vulkan-loader-generic, zlib"
