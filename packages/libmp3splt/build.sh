...
TERMUX_PKG_SRCURL="https://prdownloads.sourceforge.net/mp3splt/libmp3splt-${TERMUX_PKG_VERSION}.tar.gz"
TERMUX_PKG_SHA256=30eed64fce58cb379b7cc6a0d8e545579cb99d0f0f31eb00b9acc8aaa1b035dc
TERMUX_PKG_DEPENDS="libflac, libid3tag, libltdl, libmad, libogg, libvorbis"
