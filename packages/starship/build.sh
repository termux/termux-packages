...
TERMUX_PKG_SHA256=24b6c17b5d948e04149bf35bfc42889ec60168c2a158ae6f90589cd993099ba5
...
termux_step_pre_configure() {
	...
	p="gix-index-0.27.0-src-fs.rs.diff"
	local d
	for d in $CARGO_HOME/registry/src/*/gix-index-0.27.0; do
		patch --silent -p1 -d ${d} \
			< "$TERMUX_PKG_BUILDER_DIR/${p}"
	done
