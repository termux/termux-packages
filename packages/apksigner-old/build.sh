...
TERMUX_PKG_DESCRIPTION="APK signing tool (old variant by @fornwall)"
...
TERMUX_PKG_CONFLICTS="apksigner"
...
termux_step_make() {
	...
	echo "dalvikvm -Xcompiler-option --compiler-filter=speed -cp $TERMUX_PREFIX/share/dex/apksigner.jar net.fornwall.apksigner.Main \"\$@\"" >> $TERMUX_PREFIX/bin/apksigner
