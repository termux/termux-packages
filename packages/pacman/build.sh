...
termux_step_pre_configure() {
	rm pacman-${TERMUX_PKG_VERSION}/scripts/libmakepkg/executable/sudo.sh.in
	rm pacman-${TERMUX_PKG_VERSION}/scripts/libmakepkg/executable/fakeroot.sh.in
}
