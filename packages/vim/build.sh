...
termux_step_post_make_install() {
	...
	cp $TERMUX_PKG_MASSAGEDIR/$TERMUX_PREFIX/share/vim/vim82/tutor/{tutor,tutor.vim,tutor.utf-8} $TERMUX_PKG_TMPDIR/
	rm -f $TERMUX_PKG_MASSAGEDIR/$TERMUX_PREFIX/share/vim/vim82/tutor/*
	cp $TERMUX_PKG_TMPDIR/{tutor,tutor.vim,tutor.utf-8} \
		$TERMUX_PKG_MASSAGEDIR/$TERMUX_PREFIX/share/vim/vim82/tutor/
}
