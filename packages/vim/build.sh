...
_VIM_MAJOR_VERSION="${TERMUX_PKG_VERSION%.*}"
_VIM_MAJOR_VERSION="${_VIM_MAJOR_VERSION/.}"

TERMUX_PKG_RM_AFTER_INSTALL="
share/vim/vim${_VIM_MAJOR_VERSION}/spell/en.ascii*
share/vim/vim${_VIM_MAJOR_VERSION}/print
share/vim/vim${_VIM_MAJOR_VERSION}/tools
"
...
termux_step_post_make_install() {
	...
	cp -r   "$TERMUX_PREFIX/share/vim/vim${_VIM_MAJOR_VERSION}/tutor/en/" \
			"$TERMUX_PREFIX/share/vim/vim${_VIM_MAJOR_VERSION}/tutor/tutor.vim" \
			"$TERMUX_PREFIX/share/vim/vim${_VIM_MAJOR_VERSION}/tutor/tutor.tutor"{,.json} \
			"$TERMUX_PREFIX/share/vim/vim${_VIM_MAJOR_VERSION}/tutor/tutor"{1,2} \
			"$TERMUX_PKG_TMPDIR/vim-tutor"
	# Remove all the tutor files
	rm -rf "$TERMUX_PREFIX/share/vim/vim${_VIM_MAJOR_VERSION}/tutor"/*
	# Copy back what we saved earlier
	cp -r "$TERMUX_PKG_TMPDIR"/vim-tutor/* "$TERMUX_PREFIX/share/vim/vim${_VIM_MAJOR_VERSION}/tutor/"
