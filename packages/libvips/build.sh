...
TERMUX_PKG_DEPENDS="cgif, fftw, fontconfig, freetype, glib, harfbuzz, imagemagick, imath, libc++, libcairo, libexif, libexpat, libheif, libimagequant, libjpeg-turbo, libjxl, libpng, librsvg, libtiff, libwebp, littlecms, openexr, openjpeg, pango, poppler"
