...
TERMUX_PKG_VERSION="2023.7.1"
TERMUX_PKG_SRCURL=https://github.com/cloudflare/cloudflared/archive/refs/tags/${TERMUX_PKG_VERSION}.tar.gz
TERMUX_PKG_SHA256=0863eadade6c6ac5838510d8fb514ec2332bb79bf54edc34e90cc79652b6c816
...
termux_step_make_install() {
	install -Dm700 -t $TERMUX_PKG_MASSAGEDIR/$TERMUX_PREFIX/bin cloudflared
}
