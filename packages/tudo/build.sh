...
TERMUX_PKG_SHA256=b736628c20da71da6b33841927cd89a80ba3a53e5d2b2c25c96d4aabb3158a32
...
termux_step_install_license() {
	...
	cp -f "$TERMUX_PKG_SRCDIR/LICENSE" "$TERMUX_PREFIX/share/doc/$TERMUX_PKG_NAME/copyright"
	cp -f "$TERMUX_PKG_SRCDIR/licenses/"* "$TERMUX_PREFIX/share/doc/$TERMUX_PKG_NAME/licenses/"
}
