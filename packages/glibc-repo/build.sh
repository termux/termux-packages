...
termux_step_create_debscripts() {
	...
	[ -f "$TERMUX_PREFIX/etc/apt/sources.list.d/glibc.list" ] && {
		...
		echo "The legacy 'sources.list.d/glibc.list' entry will be migrated"
		echo "to 'sources.list.d/glibc.sources' as part of the update"
		cp -vaf \\
			"$TERMUX_PREFIX"/etc/apt/sources.list.d/glibc.list \\
			"$TERMUX_PREFIX"/etc/apt/sources.list.d/glibc.list.dpkg-old
	...
	[ -f "$TERMUX_PREFIX/etc/apt/sources.list.d/glibc.list" ] && rm "$TERMUX_PREFIX/etc/apt/sources.list.d/glibc.list"
