...
TERMUX_PKG_DESCRIPTION="Libcddb is a C library to access data on a CDDB server"
...
TERMUX_PKG_EXTRA_CONFIGURE_ARGS="--disable-static --build=aarch64-unknown-linux-gnu"
