...
TERMUX_PKG_VERSION=1.2.184
TERMUX_PKG_SRCURL=https://github.com/KhronosGroup/Vulkan-Tools/archive/v${TERMUX_PKG_VERSION}.tar.gz
TERMUX_PKG_SHA256=fc0730eae7c9b7c760af92aa465697c5e97c6519f4bf1624a147de9b5a4a0a4c
TERMUX_PKG_DEPENDS="vulkan-headers, vulkan-loader-android"
