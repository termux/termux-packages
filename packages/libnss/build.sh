...
TERMUX_PKG_VERSION="3.119.1"
TERMUX_PKG_SRCURL=https://archive.mozilla.org/pub/security/nss/releases/NSS_${TERMUX_PKG_VERSION//./_}_RTM/src/nss-${TERMUX_PKG_VERSION//./_}.tar.gz
TERMUX_PKG_SHA256=1387b8478e6c681c533b1f7b0f4d4ef7f58307c1f7e3a353622ddbf841328283
