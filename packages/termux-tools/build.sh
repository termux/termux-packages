...
termux_step_make_install () {
	...
	rm -f $TERMUX_PREFIX/bin/{termux-fix-shebang,termux-reload-style,chsh,termux-open-url}
	cp $TERMUX_PKG_BUILDER_DIR/{termux-fix-shebang,termux-reload-style,chsh,termux-open-url} $TERMUX_PREFIX/bin/
