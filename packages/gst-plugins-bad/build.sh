...
TERMUX_PKG_DEPENDS="gst-plugins-base, libmp3lame, libx264, libbz2, libpng, librsvg, libcurl, libx265, libsndfile, openjpeg, openal-soft, glib, gstreamer, openssl, libjpeg-turbo"
