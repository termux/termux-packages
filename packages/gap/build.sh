...
termux_step_post_make_install() {
	...
	# TODO: install at least gapdoc, smallgrp, transgrp, primgrp
	# or else this package is mostly useless.
	...
	#gzip -9 -n -f $TERMUX_PREFIX/lib/gap/pkg/smallgrp/data/id*/*.*
	#gzip -9 -n -f $TERMUX_PREFIX/lib/gap/pkg/smallgrp/data/small*/*.*
}
