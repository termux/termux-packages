...
termux_step_make() {
 ...
 sed -i "s/x86_64-linux-gnu-gcc/${TERMUX_ARCH}-linux-android-clang/g" Makefile
  ...
  sed -i "s#/usr/lib/x86_64-linux-gnu/perl/5.26/CORE#${PERL_DIR}/${TERMUX_ARCH}-android/CORE#g" Expat/Makefile
  make -j 4
 }
