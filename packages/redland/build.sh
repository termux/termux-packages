...
TERMUX_PKG_SRCURL="https://download.librdf.org/source/redland-${TERMUX_PKG_VERSION}.tar.gz"
TERMUX_PKG_SHA256=de1847f7b59021c16bdc72abb4d8e2d9187cd6124d69156f3326dd34ee043681
TERMUX_PKG_DEPENDS="libltdl, libraptor2, mariadb, postgresql, rasqal, sqlite, unixodbc"
