...
TERMUX_PKG_VERSION=(
	5.1.0
	2.9.12 # libxml2 version
	0.32.1 # libneon version
)
TERMUX_PKG_REVISION=3
TERMUX_PKG_SRCURL=(
	https://github.com/metabrainz/libmusicbrainz/releases/download/release-${TERMUX_PKG_VERSION}/libmusicbrainz-${TERMUX_PKG_VERSION}.tar.gz
