...
TERMUX_PKG_SHA256=3665a7ae611ccb739765fcccee4d3398b27c7693ae1ece2f29adaf84629725b5
...
termux_step_pre_configure() {
	...
	sed -i "s/-Werror=/-W/" ${TERMUX_PKG_SRCDIR}/meson.build
