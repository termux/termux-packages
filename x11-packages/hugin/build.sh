...
TERMUX_PKG_DEPENDS="boost, enblend, exiftool, exiv2, fftw, glu, imath, libc++, libepoxy, libflann, liblz4, libpano13, libsqlite, libtiff, libvigra, libx11, littlecms, openexr, opengl, wxwidgets"
