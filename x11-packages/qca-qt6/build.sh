...
TERMUX_PKG_DEPENDS="ca-certificates, libnss"
TERMUX_PKG_BUILD_DEPENDS="botan3, libgcrypt, libsasl, openssl, qt6-qt5compat, qt6-qtbase"
TERMUX_PKG_RECOMMENDS="botan3, libgcrypt, libsasl, openssl"
