...
TERMUX_PKG_DEPENDS="glib, gst-plugins-bad, gst-plugins-base, gstreamer, libc++, opengl, pulseaudio, qt6-qtbase"
TERMUX_PKG_BUILD_DEPENDS="qt6-shadertools, qt6-shadertools-cross-tools"
