...
TERMUX_PKG_SHA256="680b01ed7c789b7ef0ee8f14faffaf2e8bdf87a56a26eb2a6f95a472e5630903"
...
echo '#!/bin/sh' > \$TERMUX_PREFIX/bin/disable_baloo.sh
echo 'balooctl6 disable || true' >> \$TERMUX_PREFIX/bin/disable_baloo.sh
chmod +x \$TERMUX_PREFIX/bin/disable_baloo.sh
sh \$TERMUX_PREFIX/bin/disable_baloo.sh
rm -f \$TERMUX_PREFIX/bin/disable_baloo.sh
"
