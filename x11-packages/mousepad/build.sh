...
TERMUX_PKG_DEPENDS="atk, fontconfig, freetype, gdk-pixbuf, glib, gtk3, gtksourceview4, harfbuzz, libandroid-shmem, libcairo, libpixman, libpng, libx11, libxcb, libxext, libxrender, pango, zlib"
