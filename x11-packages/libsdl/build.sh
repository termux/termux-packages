...
TERMUX_PKG_DEPENDS="libx11, libxext, libxrandr, libxrender, pulseaudio"
TERMUX_PKG_EXTRA_CONFIGURE_ARGS="--disable-assembly --disable-nasm --disable-pth --disable-video-opengl"
