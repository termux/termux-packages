...
TERMUX_PKG_DEPENDS="cmark, editorconfig-core-c, jsonrpc-glib, glib, gobject-introspection, gtk4, gtksourceview5, libadwaita, libandroid-wordexp, libdex, libgit2-glib, libpanel, libpeas2, libportal-gtk4, libspelling, libvte, libxml2, libyaml, template-glib, webkitgtk-6.0"
