...
TERMUX_PKG_DEPENDS="boost, cmark, libc++, libebml, libflac, libgmp, libiconv, libmatroska, libogg, libvorbis, qt6-qtbase, qt6-qtsvg, qt6-qtmultimedia, zlib"
