...
share/vim/vim92/spell/en.ascii*
share/vim/vim92/print
share/vim/vim92/tools
"
...
termux_step_post_make_install() {
	...
	cp -r   "$TERMUX_PREFIX/share/vim/vim92/tutor/en/" \
			"$TERMUX_PREFIX/share/vim/vim92/tutor/tutor.vim" \
			"$TERMUX_PREFIX/share/vim/vim92/tutor/tutor.tutor"{,.json} \
			"$TERMUX_PREFIX/share/vim/vim92/tutor/tutor"{1,2} \
			"$TERMUX_PKG_TMPDIR/vim-tutor"
	# Remove all the tutor files
	rm -rf "$TERMUX_PREFIX/share/vim/vim92/tutor"/*
	# Copy back what we saved earlier
	cp -r "$TERMUX_PKG_TMPDIR"/vim-tutor/* "$TERMUX_PREFIX/share/vim/vim92/tutor/"
