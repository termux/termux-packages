...
TERMUX_PKG_DEPENDS="gdk-pixbuf, gtk3, libhandy, libarchive, djvulibre, texlive-bin, libspectre, poppler, libxml2, libtiff, libgxps, libsecret, gstreamer, gst-plugins-good"
