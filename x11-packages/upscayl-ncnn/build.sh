...
TERMUX_PKG_DESCRIPTION="The Upscayl backend powered by the NCNN framework and Real-ESRGAN architecture. "
...
TERMUX_PKG_SRCURL=(
	...
	"https://github.com/xinntao/Real-ESRGAN/releases/download/v${TERMUX_PKG_VERSION[1]}/realesrgan-ncnn-vulkan-${TERMUX_PKG_VERSION[2]}-ubuntu.zip"
)
...
TERMUX_PKG_DEPENDS="libncnn, libwebp"
TERMUX_PKG_BUILD_DEPENDS="glslang, shaderc, vulkan-headers, vulkan-loader-android"
