...
TERMUX_PKG_DEPENDS="libglvnd, libtheora, libvorbis, libvpx, libwebp, libwslay, libxcursor, libxi, libxinerama, libxrandr, mbedtls, miniupnpc, opusfile, ca-certificates, speechd, mesa, libenet, libxkbcommon, glu"
