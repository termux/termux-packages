...
termux_step_pre_configure() {
	...
	if [ "$TERMUX_ON_DEVICE_BUILD" = "false" ]; then
		...
		termux_download https://download.gimp.org/gimp/v${TERMUX_PKG_VERSION%.*}/linux/GIMP-${TERMUX_PKG_VERSION}-x86_64.AppImage "$TERMUX_PKG_CACHEDIR/gimp.appimage" cf1e7f089c58bd5e923f7e3d5a60982a9b5c454a7ea9a8f9d781d4553f12f284
