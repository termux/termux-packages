TERMUX_PKG_HOMEPAGE=https://codeberg.org/ifreund/zig-wlroots
TERMUX_PKG_DESCRIPTION="Zig bindings for wlroots"
TERMUX_PKG_LICENSE="MIT"
TERMUX_PKG_MAINTAINER="@termux"
TERMUX_PKG_VERSION=0.18.2
TERMUX_PKG_SRCURL="https://codeberg.org/ifreund/zig-wlroots/archive/v${TERMUX_PKG_VERSION}.tar.gz"
