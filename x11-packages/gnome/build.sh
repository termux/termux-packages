...
TERMUX_PKG_DEPENDS="epiphany, gnome-backgrounds, gnome-calculator, gnome-control-center, gnome-keyring, gnome-menus, gnome-session, gnome-settings-daemon, gnome-shell, gvfs, nautilus, orca"
