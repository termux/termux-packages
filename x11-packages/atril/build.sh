...
TERMUX_PKG_DEPENDS="atk, djvulibre, gdk-pixbuf, glib, gtk3, harfbuzz, libarchive, libc++, libcairo, libgepub, libice, libsecret, libsm, libspectre, libsoup3, libsynctex, libtiff, libxml2, mate-desktop, pango, poppler, webkit2gtk-4.1, zlib"
