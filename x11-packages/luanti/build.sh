...
TERMUX_PKG_DEPENDS="freetype, jsoncpp, libandroid-spawn, libc++, libcurl, libgmp, libiconv, libjpeg-turbo, libpng, libvorbis, luajit, luanti-common, openal-soft, opengl, sdl3, sqlite, xdg-utils, zlib, zstd"
