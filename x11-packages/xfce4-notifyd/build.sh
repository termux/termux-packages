...
TERMUX_PKG_DEPENDS="atk, gdk-pixbuf, glib, gtk-layer-shell, gtk3, harfbuzz, libcairo, libnotify, libx11, libxfce4ui, libxfce4util, pango, sqlite, xfce4-panel, xfconf, zlib"
