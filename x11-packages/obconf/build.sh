...
TERMUX_PKG_DEPENDS="atk, fontconfig, freetype, gdk-pixbuf, glib, gtk2, imlib2, libcairo, libglade, libice, librsvg, libsm, libx11, libxft, libxml2, openbox, pango, startup-notification"
