...
TERMUX_PKG_DEPENDS="atk, fontconfig, freetype, gdk-pixbuf, glib, gtk3, harfbuzz, libandroid-shmem, libcairo, libpixman, libpng, libsoup, libx11, libxcb, libxext, libxml2, libxrender, pango, zlib"
