...
TERMUX_PKG_DEPENDS="glib, gobject-introspection, cjs, muffin, cinnamon-menus, dbus, gcr, gdk-pixbuf, atk, opengl, gtk3, pango, xapp, libx11, libxml2, intltool, sassc, cogl, clutter, clutter-gtk, gnome-backgrounds, cinnamon-control-center, python-pillow, python3-xapp, gettext"
...
termux_step_post_make_install() {
	...
	cat >"$schemas_dir/10_cinnamon-wallpaper.gschema.override" <<EOF
