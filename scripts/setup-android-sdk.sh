...
if [ ! -d $ANDROID_HOME ]; then
	...
	curl --fail --retry 3 -C - \
		-o tools.zip \
		https://dl.google.com/android/repository/${ANDROID_SDK_FILE} || printf "%s\\n" "Signal generated by ${0##*/} curl ${ANDROID_SDK_FILE}; Continuing..."
...
if [ ! -d $NDK ]; then
	...
	curl  -C - --fail --retry 3 -o ndk.zip \
		https://dl.google.com/android/repository/${ANDROID_NDK_FILE} || printf "%s\\n" "Signal generated by ${0##*/} curl ${ANDROID_NDK_FILE}; Continuing..."
