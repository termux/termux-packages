...
termux_setup_golang() {
	if [ "$TERMUX_ON_DEVICE_BUILD" = "false" ]; then
		local TERMUX_GO_VERSION=go1.21.1
		local TERMUX_GO_SHA256=b3075ae1ce5dab85f89bc7905d1632de23ca196bd8336afd93fa97434cfa55ae
		if [ "$TERMUX_PKG_GO_USE_OLDER" = "true" ]; then
			TERMUX_GO_VERSION=go1.20.8
			TERMUX_GO_SHA256=cc97c28d9c252fbf28f91950d830201aa403836cbed702a05932e63f7f0c7bc4
		fi
